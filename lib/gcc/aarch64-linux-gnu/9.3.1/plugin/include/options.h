...
enum opt_code
{
  ...
  OPT_moutline_atomics = 1291,               /* -moutline-atomics */
  ...
  OPT_o = 1318,                              /* -o */
  OPT_p = 1319,                              /* -p */
  OPT_pass_exit_codes = 1320,                /* -pass-exit-codes */
  /* OPT_pedantic = 1321, */                 /* -pedantic */
  OPT_pedantic_errors = 1322,                /* -pedantic-errors */
  OPT_pg = 1323,                             /* -pg */
  OPT_pie = 1324,                            /* -pie */
  OPT_pipe = 1325,                           /* -pipe */
  OPT_posix = 1326,                          /* -posix */
  OPT_print_file_name_ = 1327,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1328,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1329,          /* -print-multi-directory */
  OPT_print_multi_lib = 1330,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1331,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1332,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1333,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1334,               /* -print-prog-name= */
  OPT_print_search_dirs = 1335,              /* -print-search-dirs */
  OPT_print_sysroot = 1336,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1337,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1338,                        /* -profile */
  OPT_pthread = 1339,                        /* -pthread */
  OPT_quiet = 1340,                          /* -quiet */
  OPT_r = 1341,                              /* -r */
  OPT_rdynamic = 1342,                       /* -rdynamic */
  OPT_remap = 1343,                          /* -remap */
  OPT_s = 1344,                              /* -s */
  OPT_save_temps = 1345,                     /* -save-temps */
  OPT_save_temps_ = 1346,                    /* -save-temps= */
  OPT_shared = 1347,                         /* -shared */
  OPT_shared_libgcc = 1348,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1349,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1360,               /* -static-libphobos */
  OPT_static_libstdc__ = 1361,               /* -static-libstdc++ */
  OPT_static_libtsan = 1362,                 /* -static-libtsan */
  OPT_static_libubsan = 1363,                /* -static-libubsan */
  OPT_static_pie = 1364,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1372,                      /* -std=c++2a */
  OPT_std_c__98 = 1373,                      /* -std=c++98 */
  OPT_std_c11 = 1374,                        /* -std=c11 */
  OPT_std_c17 = 1375,                        /* -std=c17 */
  /* OPT_std_c18 = 1376, */                  /* -std=c18 */
  /* OPT_std_c1x = 1377, */                  /* -std=c1x */
  OPT_std_c2x = 1378,                        /* -std=c2x */
  /* OPT_std_c89 = 1379, */                  /* -std=c89 */
  OPT_std_c90 = 1380,                        /* -std=c90 */
  OPT_std_c99 = 1381,                        /* -std=c99 */
  /* OPT_std_c9x = 1382, */                  /* -std=c9x */
  OPT_std_f2003 = 1383,                      /* -std=f2003 */
  OPT_std_f2008 = 1384,                      /* -std=f2008 */
  OPT_std_f2008ts = 1385,                    /* -std=f2008ts */
  OPT_std_f2018 = 1386,                      /* -std=f2018 */
  OPT_std_f95 = 1387,                        /* -std=f95 */
  OPT_std_gnu = 1388,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1389, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1390, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1391,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1392,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1393,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1394, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1395, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1396,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1397,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1398,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1399,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1400, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1401, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1402,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1403, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1404,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1405,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1406, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1407, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1408,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1409, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1410, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1411, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1412, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1413, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1414,                     /* -std=legacy */
  OPT_symbolic = 1415,                       /* -symbolic */
  OPT_t = 1416,                              /* -t */
  OPT_time = 1417,                           /* -time */
  OPT_time_ = 1418,                          /* -time= */
  OPT_traditional = 1419,                    /* -traditional */
  OPT_traditional_cpp = 1420,                /* -traditional-cpp */
  OPT_trigraphs = 1421,                      /* -trigraphs */
  OPT_u = 1422,                              /* -u */
  OPT_undef = 1423,                          /* -undef */
  OPT_v = 1424,                              /* -v */
  OPT_version = 1425,                        /* -version */
  OPT_w = 1426,                              /* -w */
  OPT_wrapper = 1427,                        /* -wrapper */
  OPT_x = 1428,                              /* -x */
  OPT_z = 1429,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
